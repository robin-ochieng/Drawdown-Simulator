list(
  sidebarLayout(
    sidebarPanel(class = 'sidebar-panel',
                 ...
                 numericInputIcon(inputId = "drawdown_start_capital", label = "Starting Capital:", value = 300000, min = 0, icon = ("KES")),
                 ...
                 div(id = "drawdown_annual_withdrawals_input", numericInputIcon(inputId = "drawdown_annual_withdrawals", label = "Total Withdrawals per Annum:", value = 12000, min = 0, icon = ("KES"))),
                 ...
                 numericInputIcon(inputId = "drawdown_annual_inflation", label = "Mean Annual Inflation:", value = 1.5, min = 0, max = 100, icon = list(NULL, icon("percent"))),
                 numericInputIcon(inputId = "drawdown_annual_inf_std_dev", label = "Standard Deviation of Annual Inflation:", value = 1, min = 0, max = 100, icon = list(NULL, icon("percent")))
    ),
    mainPanel(
